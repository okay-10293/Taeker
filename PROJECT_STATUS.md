...
| 마이페이지 | 10% | 60% | 변경 없음 |
| 학교 기능 (급식/시간표/학사일정, NEIS 연동) | 15% | 90% | NEIS 학교코드 등록 완료 (`ATPT_OFCDC_SC_CODE=J10`, `SD_SCHUL_CODE=7530209`, 경기도교육청). 실제 급식 데이터로 검증 후 `school_config`에 반영 — 급식/시간표/학사일정 정상 표시되어야 함 |
